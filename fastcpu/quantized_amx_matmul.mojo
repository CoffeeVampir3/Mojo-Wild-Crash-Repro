...
fn matmul_amx_uint8_int8_quantized_blocked[
    M: Int,
    N: Int,
    K: Int,
    PACK_N_BLOCK: Int,
...
fn matmul_amx_uint8_int8_quantized_blocked_parallel[
    M: Int,
    N: Int,
    K: Int,
    PACK_N_BLOCK: Int,
    ...
    fn worker(thread_id: Int):
        ...
        matmul_amx_uint8_int8_quantized_blocked[
            M, N, K, PACK_N_BLOCK, PACK_K_BLOCK,
            A_layout, B_layout, C_layout,
            A_scales_layout, B_scales_layout
